...
Процедура Подключить(Команда)
	...
	Если НЕ ТестоваяКомпонента = Неопределено Тогда
		...
		Элементы.ДекорацияИнформация.Заголовок = "Подключите сканер к " + ОписаниеУстройства +" и выбирете устройство"; 									
		
		Элементы.ДекорацияПодвал.Заголовок = "Компонента подключена";
		ПолучитьУстройства()
	КонецЕсли;
КонецПроцедуры
