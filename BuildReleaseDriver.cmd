...
del outputTest.zip
tar.exe -a -c -f outputTest.zip ru_bootcode_btscaner.apk INFO.XML ANDROID_MANIFEST_EXTENTIONS.XML MANIFEST.XML BTScaner_ARM.so BTScaner_ARM64.so BTScaner_x64.so BTScaner_x86.so
